...
<html>
<head>
	<title>Vincent's Music Center!!</title>
	<link rel="stylesheet" type="text/css" href="assets/css/register.css">
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
	<script src="assets/js/register.js"></script>
</head>
<body>
	Vincent's Music Center!!
		...
		<div id="loginContainer">
			...
			<div id="inputContainer">
				<form id="loginForm" action="register.php" method="POST">
					...
					<button type="submit" name="loginButton">Log In & Visit</button>
			...
			<div id="loginText">
				<h1>Get healing music, right now</h1>
				<h2>Listen to loads of songs for free!!</h2>

				<ul>
					<li>Discover seasonal music</li>
					<li>Create your specific song lists</li>
